...
<html lang="en">
	...
	<body>
		...
		<title><?= "This is ASE 230 - Noah Dees"; ?></title>
		<div class="container text-center mb-5">
			<h1><?= "This is ASE 230 - Noah Dees"; ?></h1>
		</div>
		<div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                   <div class="mb-2">
                       <?="<img class=\"w-100\" src=\"picture.jpg\" width=\"600\" height=\"400\" alt=\"\">";?>
                   </div>
                   <div class="mb-2 d-flex">
                       <h4 class="font-weight-normal"><?= "Noah Dees"; ?></h4>
                ...
                <div class="mb-2">
                    <ul class="list-unstyled">
                        <li class="media">
                            ...
                            <label class="media-body"><?= "Python Coder"; ?></label>
                        </li>
                        <li class="media">
                            <span class="w-25 text-black font-weight-normal">Dream Company:</span>
                            <label class="media-body"><?= "IBM"; ?></label>
                        </li>
                        <li class="media">
                            <span class="w-25 text-black font-weight-normal">Email:</span>
                            <label class="media-body"><?= "deesn1@nku.edu"; ?></label>
                        </li>
                    </ul>
                </div>
              </div>
              <div class="col-lg-7 col-md-6 pl-xl-3">
                   ...
                   <p><?= "I am a senior at Northern Kentucky University in my final semester. I am ready to finish off my college career with some Server-Side Programming!"; ?></p>
                   <div class="my-2 bg-light p-2">
                     <p class="font-italic mb-0"><?= "I may not always have good habits in terms of spending my time or money (which I am working on), but I do have the knowledge to get me out of trouble most of the time!"; ?></p>
                   </div>
                   ...
                   <p><?= "I graduated as the Salutatorian of my high school class and I love to fish."; ?></p>
              </div>
            </div>
        </div>
    </body>
